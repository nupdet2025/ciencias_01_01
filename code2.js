...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.intro3Code.GDgoObjects1.length;i<l;++i) {
    if ( gdjs.intro3Code.GDgoObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.intro3Code.GDgoObjects1[k] = gdjs.intro3Code.GDgoObjects1[i];
        ++k;
    }
}
gdjs.intro3Code.GDgoObjects1.length = k;
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9067108);
}
}
}
if (isConditionTrue_0) {
...
gdjs.intro3Code.eventsList0(runtimeScene);
gdjs.intro3Code.GDgoObjects1.length = 0;
gdjs.intro3Code.GDgoObjects2.length = 0;
gdjs.intro3Code.GDcursorObjects1.length = 0;
gdjs.intro3Code.GDcursorObjects2.length = 0;
